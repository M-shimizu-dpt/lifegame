...
import lifegame.game.object.map.print.frames.closingframe.AssetsFrame;
import lifegame.game.object.map.print.frames.closingframe.RevenueFrame;
...
public abstract class FrameEvent{
	...
	public static void openShopFront() {
		play.close();
		shopFront.open(CardEvent.getElectedCard());
	}
