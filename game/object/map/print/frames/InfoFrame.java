...
public class InfoFrame extends FrameModel{
	...
	public void open() {
		...
		JLabel titleNowAssets = createText(270,20,100,100,20,"現在の資産");
		...
		if((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[0])<10000) {
			...
			player1Assets = createText(270,120,100,100,20,String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[0])/10000)+"億"+String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[0])%10000)+"万円");
		}
		if((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[1])<10000) {
			player2Assets = createText(270,120,100,100,20,String.valueOf(ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[1])+"万円");
		}else if((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[1])%10000 == 0) {
			player2Assets = createText(270,120,100,100,20,String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[1])/10000)+"億円");
		}else {
			player2Assets = createText(270,120,100,100,20,String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[1])/10000)+"億"+String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[1])%10000)+"万円");
		}
		if((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[2])<10000) {
			player3Assets = createText(270,120,100,100,20,String.valueOf(ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[2])+"万円");
		}else if((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[2])%10000 == 0) {
			player3Assets = createText(270,120,100,100,20,String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[2])/10000)+"億円");
		}else {
			player3Assets = createText(270,120,100,100,20,String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[2])/10000)+"億"+String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[2])%10000)+"万円");
		}
		if((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[3])<10000) {
			player4Assets = createText(270,120,100,100,20,String.valueOf(ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[3])+"万円");
		}else if((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[3])%10000 == 0) {
			player4Assets = createText(270,120,100,100,20,String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[3])/10000)+"億円");
		}else {
			player4Assets = createText(270,120,100,100,20,String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[3])/10000)+"億"+String.valueOf((ClosingEvent.getNowAssetsList(ClosingEvent.getNowAssetsListSize()-1)[3])%10000)+"万円");
		}
