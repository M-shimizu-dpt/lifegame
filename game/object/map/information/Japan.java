...
public class Japan {
	...
	public Japan() {
		...
		//赤穂
		stations.get(0).addProperty(new Property("塩饅頭屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(0).addProperty(new Property("忠臣蔵グッズ屋", 1000, 6, 1.0, 1.5, 2.0));
		stations.get(0).addProperty(new Property("布海苔養殖場", 30000, 4, 0.01, 0.02, 0.03));
		stations.get(0).addProperty(new Property("製塩工場", 70000, 1, 0.03, 0.04, 0.05));//3
		stations.get(0).addProperty(new Property("製塩工場", 70000, 1, 0.03, 0.04, 0.05));//3
		stations.get(0).addProperty(new Property("製塩工場", 70000, 1, 0.03, 0.04, 0.05));//3
		//姫路
		stations.get(1).addProperty(new Property("手延べそうめん屋", 1000, 1, 0.25, 0.3, 0.4));//2
		stations.get(1).addProperty(new Property("手延べそうめん屋", 1000, 1, 0.25, 0.3, 0.4));//2
		stations.get(1).addProperty(new Property("焼きアナゴ屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(1).addProperty(new Property("焼きアナゴ屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(1).addProperty(new Property("革製品工場", 10000, 4, 0.02, 0.03, 0.04));
		stations.get(1).addProperty(new Property("石油工場", 800000, 4, 0.01, 0.03, 0.05));
		stations.get(1).addProperty(new Property("化学工場", 1000000, 4, 0.01, 0.03, 0.05));
		stations.get(1).addProperty(new Property("製鉄所", 1400000, 4, 0.03, 0.04, 0.05));
		//明石
		stations.get(2).addProperty(new Property("明石たこ焼き屋", 1000, 1, 0.5, 0.6, 0.7));//4
		stations.get(2).addProperty(new Property("明石たこ焼き屋", 1000, 1, 0.5, 0.6, 0.7));//4
		stations.get(2).addProperty(new Property("明石たこ焼き屋", 1000, 1, 0.5, 0.6, 0.7));//4
		stations.get(2).addProperty(new Property("明石たこ焼き屋", 1000, 1, 0.5, 0.6, 0.7));//4
		stations.get(2).addProperty(new Property("海鮮市場", 60000, 4, 0.02, 0.03, 0.04));
		//淡路島
		stations.get(3).addProperty(new Property("引き戻し屋", 500, 6, 1.0, 2.0, 3.0));
		stations.get(3).addProperty(new Property("玉ねぎ畑", 5000, 2, 0.08, 0.12, 0.16));//2
		stations.get(3).addProperty(new Property("玉ねぎ畑", 5000, 2, 0.08, 0.12, 0.16));//2
		stations.get(3).addProperty(new Property("お香工場", 10000, 5, 0.02, 0.04, 0.06));
		stations.get(3).addProperty(new Property("淡路瓦工場", 30000, 5, 0.01, 0.02, 0.03));
		//城崎
		stations.get(4).addProperty(new Property("湯上りジュース屋", 500, 1, 0.5, 0.7, 0.8));
		stations.get(4).addProperty(new Property("カニ寿司屋", 1000, 1, 0.25, 0.3, 0.5));
		stations.get(4).addProperty(new Property("麦わら細工工房", 3000, 3, 0.25, 0.3, 0.5));
		stations.get(4).addProperty(new Property("城崎温泉旅館", 100000, 3, 0.02, 0.03, 0.05));
		stations.get(4).addProperty(new Property("カニ割烹旅館", 200000, 3, 0.05, 0.06, 0.07));
		//福知山
		stations.get(5).addProperty(new Property("音頭せんべい屋", 1000, 1, 0.5, 1.0, 1.5));
		stations.get(5).addProperty(new Property("ブドウ園", 5000, 2, 0.05, 0.06, 0.07));
		stations.get(5).addProperty(new Property("タケノコ林", 8000, 2, 0.05, 0.06, 0.07));
		stations.get(5).addProperty(new Property("栗のテリーヌ屋", 20000, 1, 0.1, 0.15 ,0.2));
		stations.get(5).addProperty(new Property("痔の薬品工場", 500000, 4, 0.1, 0.15, 0.2));
		stations.get(5).addProperty(new Property("磁気テープ工場", 600000, 4, 0.03, 0.04, 0.05));
		stations.get(5).addProperty(new Property("ビタミン剤工場", 1000000, 4, 0.07, 0.1, 0.13));
		//三田
		stations.get(6).addProperty(new Property("すき焼きパン屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(6).addProperty(new Property("丹波栗屋", 10000, 1, 0.02, 0.03, 0.04));//2
		stations.get(6).addProperty(new Property("丹波栗屋", 10000, 1, 0.02, 0.03, 0.04));//2
		stations.get(6).addProperty(new Property("三田牛ステーキ屋", 30000, 1, 0.03, 0.04, 0.05));
		stations.get(6).addProperty(new Property("丹波松茸屋", 50000, 1, 0.07, 0.08, 0.09));
		//神戸
		stations.get(7).addProperty(new Property("そばめし屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(7).addProperty(new Property("そばめし屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(7).addProperty(new Property("フランスパン屋", 10000, 1, 0.03, 0.04, 0.05));//2
		stations.get(7).addProperty(new Property("フランスパン屋", 10000, 1, 0.03, 0.04, 0.05));//2
		stations.get(7).addProperty(new Property("中華飯店", 100000, 1, 0.02, 0.03, 0.05));
		stations.get(7).addProperty(new Property("ステーキハウス", 150000, 1, 0.03, 0.05, 0.07));
		stations.get(7).addProperty(new Property("ハーバーパーク", 1300000, 3, 0.02, 0.03, 0.04));
		stations.get(7).addProperty(new Property("南京町中華街", 2000000, 1, 0.02, 0.03, 0.04));
		//吹田
		stations.get(8).addProperty(new Property("くずきり工場", 20000, 1, 0.03, 0.04, 0.05));
		stations.get(8).addProperty(new Property("げりぴー工場", 50000, 5, 0.02, 0.03, 0.04));
		stations.get(8).addProperty(new Property("てっぺん化粧品工場", 60000, 5, 0.02, 0.03, 0.04));
		stations.get(8).addProperty(new Property("即席めん工場", 600000, 1, 0.07, 0.08, 0.09));
		stations.get(8).addProperty(new Property("ビール工場", 1000000, 1, 0.04, 0.05, 0.06));
		stations.get(8).addProperty(new Property("ぞうきん工場", 1200000, 5, 0.02, 0.03, 0.04));
		stations.get(8).addProperty(new Property("目薬メーカー", 1500000, 5, 0.04, 0.05, 0.06));
		//出石
		stations.get(9).addProperty(new Property("皿そば屋", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(9).addProperty(new Property("皿そば屋", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(9).addProperty(new Property("皿そば屋", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(9).addProperty(new Property("露店トマト店", 1000, 1, 0.8, 1.0, 1.5));
		stations.get(9).addProperty(new Property("出石白磁工房", 10000, 6, 0.01, 0.02, 0.03));
		//天保山
		stations.get(10).addProperty(new Property("ロックカフェ", 20000, 1, 0.03, 0.04, 0.05));
		stations.get(10).addProperty(new Property("大観覧車", 400000, 3, 0.03, 0.04, 0.05));
		stations.get(10).addProperty(new Property("アウトレットモール", 1000000, 6, 0.04, 0.05, 0.06));
		stations.get(10).addProperty(new Property("ジンベイザメ水族館", 6000000, 3, 0.1, 0.2, 0.3));
		stations.get(10).addProperty(new Property("映画ランドジャパン", 35000000, 3, 0.01, 0.02, 0.03));
		//堺
		stations.get(11).addProperty(new Property("かすうどん屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(11).addProperty(new Property("かすうどん屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(11).addProperty(new Property("くるみ餅屋", 1000, 1, 1.0, 2.0, 3.0));
		stations.get(11).addProperty(new Property("刃物工場", 20000, 5, 0.03, 0.04, 0.05));
		stations.get(11).addProperty(new Property("クラッカー菓子工場", 20000, 1, 0.07, 0.08, 0.09));
		stations.get(11).addProperty(new Property("回転寿司チェーン", 200000, 1, 0.07, 0.08, 0.09));
		stations.get(11).addProperty(new Property("引越センター", 370000, 6, 0.07, 0.08, 0.09));
		//岸和田
		stations.get(12).addProperty(new Property("だんじりグッズ屋", 1000, 3, 1.0, 2.0, 3.0));
		stations.get(12).addProperty(new Property("玉ねぎ畑", 3000, 2, 0.05, 0.06, 0.07));
		stations.get(12).addProperty(new Property("水ナス畑", 5000, 2, 0.1, 0.11, 0.12));//2
		stations.get(12).addProperty(new Property("水ナス畑", 5000, 2, 0.1, 0.11, 0.12));//2
		stations.get(12).addProperty(new Property("顕微鏡ガラス工場", 200000, 5, 0.02, 0.03, 0.04));
		//和歌山
		stations.get(13).addProperty(new Property("ミカン畑", 5000, 2, 0.05, 0.08, 0.1));//4
		stations.get(13).addProperty(new Property("ミカン畑", 5000, 2, 0.05, 0.08, 0.1));//4
		stations.get(13).addProperty(new Property("ミカン畑", 5000, 2, 0.05, 0.08, 0.1));//4
		stations.get(13).addProperty(new Property("ミカン畑", 5000, 2, 0.05, 0.08, 0.1));//4
		stations.get(13).addProperty(new Property("富有柿園", 5000, 2, 0.1, 0.15, 0.2));
		stations.get(13).addProperty(new Property("ネーブル園", 8000, 2, 0.05, 0.08, 0.1));
		stations.get(13).addProperty(new Property("梅干し林", 10000, 2, 0.05, 0.08, 0.1));//2
		stations.get(13).addProperty(new Property("梅干し林", 10000, 2, 0.05, 0.08, 0.1));//2
		//御坊
		stations.get(14).addProperty(new Property("ジャンボかまぼこ屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(14).addProperty(new Property("ピーマン畑", 3000, 2, 0.05, 0.06, 0.07));
		stations.get(14).addProperty(new Property("ミカン畑", 5000, 2, 0.08, 0.1, 0.12));//2
		stations.get(14).addProperty(new Property("ミカン畑", 5000, 2, 0.08, 0.1, 0.12));//2
		stations.get(14).addProperty(new Property("梅林", 8000, 2, 0.05, 0.06, 0.07));//2
		stations.get(14).addProperty(new Property("梅林", 8000, 2, 0.05, 0.06, 0.07));//2
		stations.get(14).addProperty(new Property("麻雀牌工場", 100000, 6, 0.1, 0.11, 0.12));
		//白浜
		stations.get(15).addProperty(new Property("レタス栽培", 3000, 2, 0.05, 0.08, 0.1));
		stations.get(15).addProperty(new Property("露天風呂", 30000, 3, 0.01, 0.02, 0.03));
		stations.get(15).addProperty(new Property("アニマルパーク", 80000, 3, 0.01, 0.02, 0.03));
		stations.get(15).addProperty(new Property("日本旅館", 100000, 3, 0.01, 0.02, 0.03));//2
		stations.get(15).addProperty(new Property("日本旅館", 100000, 3, 0.01, 0.02, 0.03));//2
		stations.get(15).addProperty(new Property("ホテル", 300000, 3, 0.02, 0.03, 0.04));//2
		stations.get(15).addProperty(new Property("ホテル", 300000, 3, 0.02, 0.03, 0.04));//2
		stations.get(15).addProperty(new Property("ゴルフ場", 500000, 6, 0.01, 0.02, 0.03));
		//大阪
		stations.get(16).addProperty(new Property("たこ焼き屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(16).addProperty(new Property("たこ焼き屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(16).addProperty(new Property("お好み焼き屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(16).addProperty(new Property("ねぎ焼き屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(16).addProperty(new Property("ねぎ焼き屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(16).addProperty(new Property("きつねうどん屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(16).addProperty(new Property("串カツ屋", 1000, 1, 0.8, 1.0, 1.5));
		stations.get(16).addProperty(new Property("はりはり鍋屋", 10000, 1, 0.05, 0.06, 0.07));
		stations.get(16).addProperty(new Property("お笑い劇場", 80000, 3, 0.1, 0.2, 0.3));
		stations.get(16).addProperty(new Property("製薬会社", 400000, 5, 0.02, 0.03, 0.05));//2
		stations.get(16).addProperty(new Property("製薬会社", 400000, 5, 0.02, 0.03, 0.05));//2
		stations.get(16).addProperty(new Property("プロ野球チーム", 770000, 3, 0.04, 0.05, 0.06));
		stations.get(16).addProperty(new Property("水族館", 1350000, 3, 0.01, 0.02, 0.03));
		stations.get(16).addProperty(new Property("テレビ局", 4440000, 3, 0.05, 0.06, 0.1));
		stations.get(16).addProperty(new Property("映画ランドジャパン", 5400000, 3, 0.02, 0.03, 0.04));
		//なんば
		stations.get(17).addProperty(new Property("たこ焼き屋", 1000, 1, 1.0, 1.5, 2.0));
		stations.get(17).addProperty(new Property("豚まん屋", 1000, 1, 1.0, 1.5, 2.0));
		stations.get(17).addProperty(new Property("お笑い劇場", 50000, 3, 0.15, 0.2, 0.25));
		stations.get(17).addProperty(new Property("黒門市場", 160000, 4, 0.06, 0.07, 0.08));
		stations.get(17).addProperty(new Property("お笑い興業", 500000, 4, 0.1, 0.12, 0.14));
		stations.get(17).addProperty(new Property("日本橋電気街", 1000000, 6, 0.03, 0.04, 0.05));
		stations.get(17).addProperty(new Property("老舗デパート", 5600000, 6, 0.04, 0.05, 0.06));
		//天王寺
		stations.get(18).addProperty(new Property("将棋場", 1000, 3, 0.5, 0.6, 0.7));
		stations.get(18).addProperty(new Property("シチューうどん屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(18).addProperty(new Property("串カツ屋", 1000, 1, 0.8, 1.0, 1.2));
		stations.get(18).addProperty(new Property("ヨーグルトケーキ屋", 1000, 1, 1.0, 1.5, 2.0));
		stations.get(18).addProperty(new Property("動物園", 400000, 3, 0.01, 0.02, 0.03));
		stations.get(18).addProperty(new Property("仰天閣タワー", 800000, 3, 0.02, 0.03, 0.04));
		stations.get(18).addProperty(new Property("あべのルルカス", 13000000, 6, 0.02, 0.03, 0.04));
		//舞鶴
		stations.get(19).addProperty(new Property("肉じゃが屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(19).addProperty(new Property("肉じゃが屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(19).addProperty(new Property("軍港カレー", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(19).addProperty(new Property("軍港カレー", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(19).addProperty(new Property("軍港カレー", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(19).addProperty(new Property("万願寺唐辛子畑", 3000, 2, 0.05, 0.08, 0.1));
		stations.get(19).addProperty(new Property("こっぺ蟹料理屋", 20000, 1, 0.05, 0.06, 0.07));//2
		stations.get(19).addProperty(new Property("こっぺ蟹料理屋", 20000, 1, 0.05, 0.06, 0.07));//2
		//北浜
		stations.get(20).addProperty(new Property("あったらいいな製薬", 350000, 5, 0.06, 0.08, 0.1));
		stations.get(20).addProperty(new Property("アルバム制作会社", 660000, 5, 0.04, 0.06, 0.08));
		stations.get(20).addProperty(new Property("シノノギ製薬", 2000000, 5, 0.04, 0.06, 0.08));
		stations.get(20).addProperty(new Property("紡績工場", 2200000, 5, 0.01, 0.02, 0.03));
		stations.get(20).addProperty(new Property("繊維メーカー", 2400000, 5, 0.01, 0.02, 0.03));
		stations.get(20).addProperty(new Property("スタミナ製薬", 5000000, 5, 0.02, 0.03, 0.4));
		stations.get(20).addProperty(new Property("ビタミンA製薬", 15000000, 5, 0.06, 0.08, 0.1));
		//京橋
		stations.get(21).addProperty(new Property("フランクフルト屋", 1000, 1, 0.8, 1.0, 1.3));
		stations.get(21).addProperty(new Property("つかみ寿司屋", 10000, 1, 0.1, 0.2, 0.3));
		stations.get(21).addProperty(new Property("お笑い劇場", 40000, 3, 0.1, 0.2, 0.3));
		stations.get(21).addProperty(new Property("テレビ局1", 100000, 3, 0.07, 0.1, 0.13));
		stations.get(21).addProperty(new Property("テレビ局2", 1000000, 3, 0.1, 0.15, 0.2));
		//鶴橋
		stations.get(22).addProperty(new Property("チヂミ屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(22).addProperty(new Property("トッポギ屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(22).addProperty(new Property("韓国キムチ屋", 1000, 1, 1.0, 1.5, 2.0));
		stations.get(22).addProperty(new Property("韓国焼き肉屋", 3000, 1, 0.8, 1.0, 1.2));//2
		stations.get(22).addProperty(new Property("韓国焼き肉屋", 3000, 1, 0.8, 1.0, 1.2));//2
		//嵐山
		stations.get(23).addProperty(new Property("湯豆腐料理屋", 10000, 1, 0.03, 0.04, 0.05));//2
		stations.get(23).addProperty(new Property("湯豆腐料理屋", 10000, 1, 0.03, 0.04, 0.05));//2
		stations.get(23).addProperty(new Property("高級料亭", 50000, 1, 0.1, 0.2, 0.3));//2
		stations.get(23).addProperty(new Property("高級料亭", 50000, 1, 0.1, 0.2, 0.3));//2
		stations.get(23).addProperty(new Property("料亭億兆", 600000, 1, 0.07, 0.1, 0.12));
		//門真
		stations.get(24).addProperty(new Property("クワイ園", 10000, 2, 0.04, 0.08, 0.1));
		stations.get(24).addProperty(new Property("自動車部品工場", 60000, 5, 0.03, 0.05, 0.07));
		stations.get(24).addProperty(new Property("経営の神様記念館", 240000, 3, 0.1, 0.2, 0.3));
		stations.get(24).addProperty(new Property("魔法瓶工場", 400000, 5, 0.03, 0.04, 0.05));
		stations.get(24).addProperty(new Property("ジェネリック薬品", 470000, 5, 0.04, 0.05, 0.06));
		stations.get(24).addProperty(new Property("電池充電器工場", 800000, 5, 0.03, 0.04, 0.05));
		stations.get(24).addProperty(new Property("ポニョソニック電機", 40000000, 5, 0.1, 0.2, 0.3));
		//五條
		stations.get(25).addProperty(new Property("柿の葉寿司屋", 1000, 1, 0.8, 1.5, 2.0));//2
		stations.get(25).addProperty(new Property("柿の葉寿司屋", 1000, 1, 0.8, 1.5, 2.0));//2
		stations.get(25).addProperty(new Property("富有柿園", 30000, 2, 0.1, 0.2, 0.3));//2
		stations.get(25).addProperty(new Property("富有柿園", 30000, 2, 0.1, 0.2, 0.3));//2
		stations.get(25).addProperty(new Property("柿ワイン工場", 50000, 1, 0.04, 0.06, 0.08));
		//京都
		stations.get(26).addProperty(new Property("油とり紙屋", 5000, 6, 0.8, 1.0, 2.0));//2
		stations.get(26).addProperty(new Property("油とり紙屋", 5000, 6, 0.8, 1.0, 2.0));//2
		stations.get(26).addProperty(new Property("麩まんじゅう屋", 10000, 1, 0.05, 0.06, 0.07));
		stations.get(26).addProperty(new Property("老舗コーヒー屋", 10000, 1, 0.08, 0.09, 0.1));
		stations.get(26).addProperty(new Property("あぶり餅屋", 10000, 1, 0.1, 0.15, 0.2));
		stations.get(26).addProperty(new Property("生八つ橋屋", 30000, 1, 0.1, 0.15, 0.2));//2
		stations.get(26).addProperty(new Property("生八つ橋屋", 30000, 1, 0.1, 0.15, 0.2));//2
		stations.get(26).addProperty(new Property("湯豆腐料理屋", 80000, 1, 0.05, 0.1, 0.15));
		stations.get(26).addProperty(new Property("錦上市場", 250000, 4, 0.04, 0.08, 0.1));
		stations.get(26).addProperty(new Property("料亭億兆", 1000000, 1, 0.05, 0.08, 0.15));
		//橿原
		stations.get(27).addProperty(new Property("柿の葉寿司", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(27).addProperty(new Property("石舞台グッズ屋", 1000, 3, 0.5, 0.6, 0.7));
		stations.get(27).addProperty(new Property("牛乳スープ鍋屋", 1000, 1, 1.0, 1.5, 2.0));
		stations.get(27).addProperty(new Property("富有柿園", 10000, 2, 0.1, 0.2, 0.3));//2
		stations.get(27).addProperty(new Property("富有柿園", 10000, 2, 0.1, 0.2, 0.3));//2
		//祇園
		stations.get(28).addProperty(new Property("天然かき氷屋", 10000, 1, 0.1, 0.2, 0.3));
		stations.get(28).addProperty(new Property("帆布工場", 10000, 5, 0.07, 0.1, 0.15));
		stations.get(28).addProperty(new Property("葛きり屋", 20000, 1, 0.1, 0.15, 0.2));
		stations.get(28).addProperty(new Property("京の米料亭", 20000, 1, 0.15, 0.2, 0.3));
		stations.get(28).addProperty(new Property("生麩屋", 30000, 1, 0.1, 0.2, 0.3));
		stations.get(28).addProperty(new Property("鮨割烹", 30000, 1, 0.15, 0.2, 0.3));
		stations.get(28).addProperty(new Property("イタリアン料理店", 40000, 1, 0.15, 0.2, 0.3));
		//奈良
		stations.get(29).addProperty(new Property("鹿せんべい屋", 1000, 1, 0.25, 0.3, 0.4));//2
		stations.get(29).addProperty(new Property("鹿せんべい屋", 1000, 1, 0.25, 0.3, 0.4));//2
		stations.get(29).addProperty(new Property("柿の葉寿司屋", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(29).addProperty(new Property("柿の葉寿司屋", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(29).addProperty(new Property("柿の葉寿司屋", 1000, 1, 0.5, 0.6, 0.7));//3
		stations.get(29).addProperty(new Property("富有柿園", 8000, 2, 0.1, 0.15, 0.2));//3
		stations.get(29).addProperty(new Property("富有柿園", 8000, 2, 0.1, 0.15, 0.2));//3
		stations.get(29).addProperty(new Property("富有柿園", 8000, 2, 0.1, 0.15, 0.2));//3
		//新宮
		stations.get(30).addProperty(new Property("さんま寿司屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(30).addProperty(new Property("さんま寿司屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(30).addProperty(new Property("めはり寿司屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(30).addProperty(new Property("めはり寿司屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(30).addProperty(new Property("ヨシノスギ林", 10000, 2, 0.05, 0.08, 0.1));//4
		stations.get(30).addProperty(new Property("ヨシノスギ林", 10000, 2, 0.05, 0.08, 0.1));//4
		stations.get(30).addProperty(new Property("ヨシノスギ林", 10000, 2, 0.05, 0.08, 0.1));//4
		stations.get(30).addProperty(new Property("ヨシノスギ林", 10000, 2, 0.05, 0.08, 0.1));//4
		//大津
		stations.get(31).addProperty(new Property("走り餅屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(31).addProperty(new Property("しじみめし屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(31).addProperty(new Property("しじみめし屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(31).addProperty(new Property("和菓子屋", 10000, 1, 0.02, 0.04, 0.06));
		stations.get(31).addProperty(new Property("産業用センサー工場", 280000, 5, 0.02, 0.04, 0.06));
		stations.get(31).addProperty(new Property("バイオ研究所", 900000, 5, 0.03, 0.04, 0.05));
		stations.get(31).addProperty(new Property("液晶用ガラス工場", 3200000, 5, 0.04, 0.05, 0.06));
		//伊賀
		stations.get(32).addProperty(new Property("手裏剣せんべい屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(32).addProperty(new Property("堅焼きせんべい屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(32).addProperty(new Property("松尾芭蕉グッズ屋", 3000, 3, 0.1, 0.15, 0.2));
		stations.get(32).addProperty(new Property("忍者屋敷", 20000, 3, 0.03, 0.04, 0.05));
		stations.get(32).addProperty(new Property("伊賀焼き物工房", 40000, 6, 0.02, 0.04, 0.06));
		stations.get(32).addProperty(new Property("伊賀牛屋", 60000, 1, 0.03, 0.04, 0.05));//2
		stations.get(32).addProperty(new Property("伊賀牛屋", 60000, 1, 0.03, 0.04, 0.05));//2
		//長浜
		stations.get(33).addProperty(new Property("焼きサバそうめん屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(33).addProperty(new Property("豊臣秀吉グッズ屋", 3000, 3, 0.8, 1.0, 2.0));
		stations.get(33).addProperty(new Property("オルゴール館", 30000, 3, 0.02, 0.03, 0.04));
		stations.get(33).addProperty(new Property("ガラス工房", 50000, 3, 0.03, 0.04, 0.05));
		stations.get(33).addProperty(new Property("フィギュア博物館", 80000, 3, 0.05, 0.06, 0.07));
		stations.get(33).addProperty(new Property("鉄道記念館", 510000, 3, 0.02, 0.03, 0.04));
		stations.get(33).addProperty(new Property("黒壁の街並み", 700000, 3, 0.02, 0.03, 0.05));
		//彦根
		stations.get(34).addProperty(new Property("ひこっしーグッズ屋", 1000, 3, 0.5, 0.6, 0.7));
		stations.get(34).addProperty(new Property("和ローソク屋", 3000, 6, 0.5, 0.6, 0.7));//2
		stations.get(34).addProperty(new Property("和ローソク屋", 3000, 6, 0.5, 0.6, 0.7));//2
		stations.get(34).addProperty(new Property("赤かぶら漬け屋", 3000, 1, 0.5, 0.6, 0.7));
		stations.get(34).addProperty(new Property("塩すき焼き屋", 10000, 1, 0.01, 0.02, 0.03));
		//近江八幡
		stations.get(35).addProperty(new Property("でっちようかん屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(35).addProperty(new Property("でっちようかん屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(35).addProperty(new Property("赤こんにゃく屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(35).addProperty(new Property("赤こんにゃく屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(35).addProperty(new Property("バウムクーヘン屋", 10000, 1, 0.1, 0.15, 0.2));
		stations.get(35).addProperty(new Property("近江牛屋", 70000, 1, 0.05, 0.06, 0.07));//2
		stations.get(35).addProperty(new Property("近江牛屋", 70000, 1, 0.05, 0.06, 0.07));//2
		stations.get(35).addProperty(new Property("製薬会社", 120000, 5, 0.02, 0.03, 0.04));
		//四日市
		stations.get(36).addProperty(new Property("とんてき屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(36).addProperty(new Property("点火プラグ工場", 750000, 5, 0.03, 0.04, 0.05));
		stations.get(36).addProperty(new Property("食品素材工場", 770000, 5, 0.03, 0.04, 0.05));
		stations.get(36).addProperty(new Property("物流倉庫会社", 840000, 6, 0.03, 0.04, 0.05));
		stations.get(36).addProperty(new Property("板ガラス工場", 1000000, 5, 0.03, 0.04, 0.05));
		stations.get(36).addProperty(new Property("石油精製工場", 2000000, 5, 0.02, 0.03, 0.04));//2
		stations.get(36).addProperty(new Property("石油精製工場", 2000000, 5, 0.02, 0.03, 0.04));//2
		//津
		stations.get(37).addProperty(new Property("福引せんべい屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(37).addProperty(new Property("巨大餃子屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(37).addProperty(new Property("うなぎ屋", 1000, 1, 0.5, 0.6, 0.7));
		stations.get(37).addProperty(new Property("天むす屋", 1000, 1, 0.8, 1.0, 2.0));
		stations.get(37).addProperty(new Property("ベビーラーメン工場", 180000, 1, 0.02, 0.03, 0.04));
		stations.get(37).addProperty(new Property("肉まんあんまん工場", 220000, 1, 0.05, 0.06, 0.07));
		stations.get(37).addProperty(new Property("造船所", 300000, 5, 0.03, 0.04, 0.05));
		//松阪
		stations.get(38).addProperty(new Property("松阪牛屋", 80000, 1, 0.03, 0.04, 0.05));//5
		stations.get(38).addProperty(new Property("松阪牛屋", 80000, 1, 0.03, 0.04, 0.05));//5
		stations.get(38).addProperty(new Property("松阪牛屋", 80000, 1, 0.03, 0.04, 0.05));//5
		stations.get(38).addProperty(new Property("松阪牛屋", 80000, 1, 0.03, 0.04, 0.05));//5
		stations.get(38).addProperty(new Property("松阪牛屋", 80000, 1, 0.03, 0.04, 0.05));//5
		//伊勢
		stations.get(39).addProperty(new Property("伊勢うどん屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(39).addProperty(new Property("伊勢うどん屋", 1000, 1, 0.5, 0.6, 0.7));//2
		stations.get(39).addProperty(new Property("てこね寿司屋", 5000, 1, 0.8, 1.0, 1.5));//2
		stations.get(39).addProperty(new Property("てこね寿司屋", 5000, 1, 0.8, 1.0, 1.5));//2
		stations.get(39).addProperty(new Property("ふくふく餅屋", 10000, 1, 0.04, 0.05, 0.06));
		stations.get(39).addProperty(new Property("戦国パーク", 100000, 3, 0.01, 0.02, 0.03));
		stations.get(39).addProperty(new Property("おまいり横丁", 2000000, 3, 0.02, 0.03, 0.04));
		//鳥羽
		stations.get(40).addProperty(new Property("真珠養殖工場", 50000, 4, 0.03, 0.05, 0.07));//2
		stations.get(40).addProperty(new Property("真珠養殖工場", 50000, 4, 0.03, 0.05, 0.07));//2
		stations.get(40).addProperty(new Property("黒鯛漁", 70000, 4, 0.04, 0.05, 0.6));
		stations.get(40).addProperty(new Property("牡蠣養殖工場", 80000, 4, 0.05, 0.06, 0.07));//2
		stations.get(40).addProperty(new Property("牡蠣養殖工場", 80000, 4, 0.05, 0.06, 0.07));//2
